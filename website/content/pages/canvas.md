...
function writeImageToCanvas(canvasId) {
	...
	context.drawImage(img, x, y, 100, 75);
}
...
function getData(canvasId) {
	...
	document.getElementById("canvasUp").innerHTML = "Canvas frame updated";
...
<img id="demo-image" src="images/demo_image.png" width="100" style="display: none">
<img id="fp-image" style="display: none"
...
<div id="canvas-wrap-1" style="width: 850px;">
    Just like clicking the buttons below, websites can track what items you click on or how you navigate their sites by clicking their menu. Each press of a button is noted in the canvas and can be later analyzed.
    <br>
	<div id="canvas1-buttons-wrap" style="width: 850px; text-align: center; margin-top: 30px">
    ...
    <br>
	<canvas id="canvas1" width="850px" height="200px" style="border:1px solid orangered;"></canvas>
</div>
<div style="width: 870px; text-align: center;">

After clicking the button, the data still visible have been sent to the attacker.
...
<button id="getData" onclick="getData('canvas1'); display: inline-block;">Get data and show image in canvas frame</button>
...
​    
​	<h3 style="width: 400px">Original canvas</h3>
​	<canvas id="canvasx" width="400px" height="60px" style="border:1px solid orangered; margin-right: 25px;"></canvas>
​	<br>
​	This canvas is what your browser sees.
</div>
​    

<div style="display: inline-block;">
		<h3 style="width: 400px">Obtained canvas</h3>
		<canvas id="resultCanvas1" width="400px" height="60px" style="border:1px solid orangered;"></canvas>
<br>
And this one is what a fingerprinter might see.
	...
	<div style="display: none">
		...
		<canvas id="resultCanvas2" width="400px" height="60px" style="border:1px solid orangered;"></canvas>
	<br>
...
Now turn JShelter on and try using safety levels as shown below. You need to refresh this page each time you change a setting.<br><br>
...
<b>Strict</b><br>
obtained canvas <u>does not</u> contain any information (is white)
