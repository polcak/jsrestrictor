...
- Use **tabulators** for indentation, and avoid spaces/tabs at the end of the
line.
- Functions, methods, classes, ifs, cycles etc. have opening braces at the same
line.
- Text width preferred less than 80 characters, maximum 100 characters. It is
better having readable code than pursuing this limit.
- Always enclose blocks of expressions into brackets.
- Names are lower case and preferably explain the purpose of the variable, class,
etc.
- Comment classes, functions, etc. in Doxygen style. Use `make doc` to generate
documentation.
...
`push --force`.
- This pull request (FIXME: need to find link) contains an example of big commits
