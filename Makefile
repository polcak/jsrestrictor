...
firefox:
	...
	@zip -q -r firefox_JSR.zip img/ manifest.json background.js document_start.js options.js options.css options.html popup.js popup.css popup.html
	@rm -f manifest.json
...
chrome:
	...
	@zip -q -r chrome_JSR.zip img/ manifest.json background.js document_start.js options.js options.css options.html popup.js popup.css popup.html
	@rm -f manifest.json
